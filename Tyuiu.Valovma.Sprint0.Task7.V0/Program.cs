using Tyuiu.Valovma.Sprint0.Task7.V0.Lib;


Console.Title = "Спринт #0 | Выполнил: Валов М. А. | ИСПБ-26-1";
            ...
            Console.WriteLine("* Выполнил: Валов Максим Алексеевич | ИСПБ-26-1                            *");
            Console.WriteLine("***************************************************************************");
